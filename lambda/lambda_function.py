    ...
    def handle(self, handler_input):
        ...
        return (
            handler_input.response_builder
                .speak("Hi, welcome to Emotion Help, you can ask me about certain emotions and how to handle your feelings")#.speak(prompts.WELCOME_MESSAGE)
                .ask("Hi, welcome to Emotion Help, you can ask me about certain emotions and how to handle your feelings")#.ask(prompts.WELCOME_MESSAGE)
                .response
        )
